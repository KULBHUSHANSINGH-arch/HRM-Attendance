...
const NAV_ITEMS = [
  ...
  { to: '/admin/holidays', label: 'Holidays', icon: SunIcon },
  { to: '/admin/reports/daily', label: 'Daily Report', icon: DocumentIcon },
  { to: '/admin/reports/monthly', label: 'Monthly Report', icon: ChartBarIcon },
